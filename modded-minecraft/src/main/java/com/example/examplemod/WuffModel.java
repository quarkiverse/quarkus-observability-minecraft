...
@OnlyIn(Dist.CLIENT)
public class WuffModel<T extends Wuff> extends ColorableAgeableListModel<T> {
    ...
    public WuffModel(ModelPart p_171087_) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition1.addOrReplaceChild("real_head",
                CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F).texOffs(16, 14)
        ...
        PartDefinition partdefinition2 = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(),
                PartPose.offsetAndRotation(-1.0F, 12.0F, 8.0F, ((float) Math.PI / 5F), 0.0F, 0.0F));
        partdefinition2.addOrReplaceChild("real_tail",
                CubeListBuilder.create().texOffs(9, 18).addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F), PartPose.ZERO);
